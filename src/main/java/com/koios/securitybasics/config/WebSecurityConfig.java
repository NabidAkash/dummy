package com.koios.securitybasics.config;

import com.koios.securitybasics.service.CustomUserDetailsService;
...
public class WebSecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .formLogin(loginConfiguration -> loginConfiguration
                        .loginPage("/login")
